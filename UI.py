...
class Variables:
    ...
    def load(self):
        self.P = mywindow.is_float(self.main_window.ui.doubleSpinBox_8)
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if DEDUG:
            self.ui.doubleSpinBox_8.setValue(100)  # P
            self.ui.doubleSpinBox_9.setValue(20)  # i
            self.ui.doubleSpinBox_10.setValue(2)  # n
            self.ui.doubleSpinBox_11.setValue(8)  # h
...
class Finish(QtWidgets.QDialog):
    def __init__(self, parent: mywindow):
        ...
        self.ui.doubleSpinBox_10.setValue(round(self.parent.calculation.C, 3))
